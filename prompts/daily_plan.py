...
Allowed program_id values (must match exactly): "ai-tutor", "ielts-speaking", "interview-prep", "daily-vocabulary", "speech-clarity".
Allowed type values: "program_session", "review", "reflection", "streak_save".
Allowed routes per program: "ai-tutor" → "/ai-tutor", "ielts-speaking" → "/ielts", "interview-prep" → "/interview-prep", "daily-vocabulary" → "/vocabulary", "speech-clarity" → "/programs/speech-clarity".
...
{{
  ...
  "items": [
    {{
      ...
      "program_id": "ai-tutor | ielts-speaking | interview-prep | daily-vocabulary | speech-clarity",
      "route": "string",
      "title": "string",
      "reason": "string",
      "estimated_minutes": 5,
